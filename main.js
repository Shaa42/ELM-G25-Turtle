...
var $author$project$Main$init = {inputValue: ''};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'UpdateInput') {
			...
			return A2($elm$core$Debug$log, model.inputValue, model);
		}
	});
var $author$project$Main$DrawButtonClicked = {$: 'DrawButtonClicked'};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$DrawButtonClicked)
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Vous avez écrit: ' + model.inputValue)
					]))
			]));
};
